  ...
  <aside class="site-off desktop-hide">
    <div class="off-canvas">
      <div class="canvas-head flexitem">
        <div class="logo">
          <a href="/bubblethemeshop"><span class="circle"></span>&nbsp;BubbleShop</a>
        </div>
            ...
            <ul class="flexitem main-links">
              ...
              <li>
                <a href="#">Bahasa Indonesia
                  <span class="icon-small"><i class="ri-arrow-down-s-line"></i></span></a>
                <ul>
                          ...
                          <div class="row">
                            <div class="media">
                              <div class="thumbnail object-cover">
                                <a href="#">
                                  <img src="<?php echo _FOLDER_ROOT_; ?>web/public/assets/clients/img/products/apparel4.jpg" alt="Produk Paling Laris" />
                                </a>
                              </div>
                            </div>
